...
public class themes_fragment extends Fragment {
    RecyclerView list;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Firebase_Operations.get_themes_of_the_hotel(getActivity().getIntent().getStringExtra("hotel_id"),list,getActivity(),"Theme offering",null);
        return v;
    }
}
