...
public class Halls_fragment extends Fragment {
    RecyclerView list;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Firebase_Operations.get_Halls_of_hotel(getActivity(),getActivity().getIntent().getStringExtra("hotel_id"),null,list,"Hall Offering",null);
        return v;
    }
