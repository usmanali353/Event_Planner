...
public class update_food_fragment extends Fragment {
    RecyclerView list;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Firebase_Operations.get_food_of_hotel(getActivity().getIntent().getStringExtra("hotel_id"),getActivity(),list,null,"Food Update",this);
        return v;
    }
